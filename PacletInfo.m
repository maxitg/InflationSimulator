...
Paclet[
    ...
    Description -> "Code for simulating inflation, including multiple field Lagrangians with non-canonical kinetic energy.",
    ...
    Extensions -> 
        {
            ...
            {"Resource", Root -> "Data", Resources -> 
                {"PlanckConstraints-TT_TE_EE_lowP-95CL.csv"}
            }
        }
]
